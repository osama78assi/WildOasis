import{I as B,n as D,a as i,j as e,p as k,J as P,K as E,N as M,f as $}from"./index-Ct-zUf6z.js";import{b as N}from"./apiBookings-yQgieiTX.js";import{b as C,f as s}from"./helpers-BKPUiegI.js";import{F}from"./Flag-TP-hyZeI.js";import{f as l}from"./format-DYgq8Nsm.js";import{i as I}from"./isToday-wT-GiqoV.js";function A(){const{bookingId:r}=B(),t=["booking",r],{isPending:a,data:o,error:n}=D({queryKey:t,queryFn:()=>N(r),retry:!1});return{booking:o,bookingId:r,isLoading:a,error:n,queryKey:t}}const U=i.div`
  display: flex;
  gap: 1.2rem;
