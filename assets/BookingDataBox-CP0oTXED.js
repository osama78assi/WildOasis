import{I as B,n as D,a as i,j as e,p as k,J as P,K as E,N as M,f as $}from"./index-CTm8NVWJ.js";import{b as N}from"./apiBookings-CejPQ2YY.js";import{b as C,f as s}from"./helpers-DDOYwYrQ.js";import{F}from"./Flag-DWF1JjKG.js";import{f as d}from"./format-CtInpAcY.js";import{i as I}from"./isToday-Cet5bj0U.js";function A(){const{bookingId:r}=B(),o=["booking",r],{isPending:a,data:t,error:n}=D({queryKey:o,queryFn:()=>N(r),retry:!1});return{booking:t,bookingId:r,isLoading:a,error:n,queryKey:o}}const U=i.div`
  display: flex;
  gap: 1.2rem;
