import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-CTXLcj4T.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-BBbHNTyV.js";import{u as Ae}from"./useSettings-D4UYzl6H.js";import{a as qe}from"./apiBookings-BZcizHZ7.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-BuJpLv72.js";import{C as ae}from"./Checkbox--tLsPYCN.js";import{F as A,I as me,a as _e}from"./Input-2BG84v2a.js";import{F as O}from"./FormRow-D5XxLNeK.js";import{F as Ke}from"./FormRowButtons-CCSOGa_m.js";import{T as Ue}from"./Textarea-BgX7s0Jh.js";import{u as pe}from"./useCabins-w96bMNRJ.js";import{I as Qe}from"./Img-9qGTZN6Z.js";import{D}from"./DropdownMenu-CYmudUPw.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-g-pPJE0k.js";import{R as ne}from"./Row-DJ7VZngJ.js";import"./apiCabins-D9bOau-5.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
