import{I as B,n as D,a as i,j as e,p as k,J as P,K as E,N as M,f as $}from"./index-3miXUnVq.js";import{b as N}from"./apiBookings-DNshKrNf.js";import{b as C,f as s}from"./helpers-Don_ybCu.js";import{F}from"./Flag-VvEP06dg.js";import{f as l}from"./format-BDzxJ6wR.js";import{i as I}from"./isToday-BtF41Yph.js";function A(){const{bookingId:r}=B(),t=["booking",r],{isPending:a,data:o,error:n}=D({queryKey:t,queryFn:()=>N(r),retry:!1});return{booking:o,bookingId:r,isLoading:a,error:n,queryKey:t}}const U=i.div`
  display: flex;
  gap: 1.2rem;
