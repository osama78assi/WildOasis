import{I as B,n as D,a as i,j as e,p as k,J as P,K as E,N as M,f as $}from"./index-CeYRl1xh.js";import{b as N}from"./apiBookings-V5lz4pqU.js";import{b as C,f as s}from"./helpers-C0ogm0-9.js";import{F}from"./Flag-CucoMojp.js";import{f as l}from"./format-BUAAIt0y.js";import{i as I}from"./isToday-MffDa4Gp.js";function A(){const{bookingId:r}=B(),t=["booking",r],{isPending:a,data:o,error:n}=D({queryKey:t,queryFn:()=>N(r),retry:!1});return{booking:o,bookingId:r,isLoading:a,error:n,queryKey:t}}const U=i.div`
  display: flex;
  gap: 1.2rem;
