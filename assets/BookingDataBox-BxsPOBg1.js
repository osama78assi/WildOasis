import{I as B,n as D,a as i,j as e,p as k,J as P,K as E,N as M,f as $}from"./index-CTXLcj4T.js";import{b as N}from"./apiBookings-BZcizHZ7.js";import{b as C,f as s}from"./helpers-BuJpLv72.js";import{F}from"./Flag-zG777W3T.js";import{f as d}from"./format-C2OtfDDC.js";import{i as I}from"./isToday-DdsJfKPO.js";function A(){const{bookingId:r}=B(),o=["booking",r],{isPending:a,data:t,error:n}=D({queryKey:o,queryFn:()=>N(r),retry:!1});return{booking:t,bookingId:r,isLoading:a,error:n,queryKey:o}}const U=i.div`
  display: flex;
  gap: 1.2rem;
