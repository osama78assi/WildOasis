import{r as c,a as h,b,j as s,M as l,m as v}from"./index-DsZ-KJuj.js";function w(e,r,t){if(r===void 0||t===void 0)throw new Error("missing functions");const i=c.useCallback(r,[r]),a=c.useCallback(t,[t]);c.useLayoutEffect(()=>{function o(){window.matchMedia(`(max-width: ${e}px)`).matches?i():a()}return o(),window.addEventListener("resize",o),()=>window.removeEventListener("resize",o)},[e,i,a])}const F=h.div`
