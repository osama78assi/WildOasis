import{I as B,n as D,a as i,j as e,p as k,J as P,K as E,N as M,f as $}from"./index-DKoFbsHf.js";import{b as N}from"./apiBookings-D_UlYpWX.js";import{b as C,f as s}from"./helpers-C3_8XVGw.js";import{F}from"./Flag-BOT63b4O.js";import{f as d}from"./format-DGxj40td.js";import{i as I}from"./isToday-Ce81RB_n.js";function A(){const{bookingId:r}=B(),o=["booking",r],{isPending:a,data:t,error:n}=D({queryKey:o,queryFn:()=>N(r),retry:!1});return{booking:t,bookingId:r,isLoading:a,error:n,queryKey:o}}const U=i.div`
  display: flex;
  gap: 1.2rem;
