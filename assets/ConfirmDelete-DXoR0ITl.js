import{r as l,a as c,j as t,d as m,D as h,E as v,i as g,g as p}from"./index-YsPsgoZE.js";function y(e,n,r=1e3){const o=l.useRef(null);l.useEffect(()=>{if(o.current&&e!=""){o.current.style.opacity=0;let a=0,s=setInterval(()=>{a+=.1,o.current.style.opacity=a,a>=1&&clearInterval(s)},r/100)}},[e,o,r]);function i(){if(o.current){let a=1,s=setInterval(()=>{a-=.1,o.current.style.opacity=a,a<=0&&(clearInterval(s),n==null||n())},r/50)}}return{fadeRef:o,fadeOut:i}}const b=c.div`
  ${e=>e.$form?`
          width: 80%;
          height: 80%;
