import{I as B,n as D,a as i,j as e,p as k,J as P,K as E,N as M,f as $}from"./index-D_d7XbGv.js";import{b as N}from"./apiBookings-B5LHiE7B.js";import{b as C,f as s}from"./helpers-9CXC5tE2.js";import{F}from"./Flag-OJt4SJJZ.js";import{f as l}from"./format-CVlm2igc.js";import{i as I}from"./isToday-BwG8wJni.js";function A(){const{bookingId:r}=B(),t=["booking",r],{isPending:a,data:o,error:n}=D({queryKey:t,queryFn:()=>N(r),retry:!1});return{booking:o,bookingId:r,isLoading:a,error:n,queryKey:t}}const U=i.div`
  display: flex;
  gap: 1.2rem;
