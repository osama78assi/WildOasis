import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-CeYRl1xh.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-0q4faTMJ.js";import{u as Ae}from"./useSettings-Do9wfxzg.js";import{a as qe}from"./apiBookings-V5lz4pqU.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-C0ogm0-9.js";import{C as ae}from"./Checkbox-C-xeRZnl.js";import{F as A,I as me,a as _e}from"./Input-D32V5rd3.js";import{F as O}from"./FormRow-B03T2RLm.js";import{F as Ke}from"./FormRowButtons-NRhTzjlR.js";import{T as Ue}from"./Textarea-BxH17gHR.js";import{u as pe}from"./useCabins-Don25rdj.js";import{I as Qe}from"./Img-Bl12U3S7.js";import{D}from"./DropdownMenu-H1PTKWwg.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-CfQeU42H.js";import{R as ne}from"./Row-CN7hRLL4.js";import"./apiCabins-g62jijii.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
