import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-CTm8NVWJ.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-uRNUnxFp.js";import{u as Ae}from"./useSettings-R2Gffszj.js";import{a as qe}from"./apiBookings-CejPQ2YY.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-DDOYwYrQ.js";import{C as ae}from"./Checkbox-fhxDO4UF.js";import{F as A,I as me,a as _e}from"./Input-CbLpjie9.js";import{F as O}from"./FormRow-BmMlfZVW.js";import{F as Ke}from"./FormRowButtons-BsGtUtD_.js";import{T as Ue}from"./Textarea-CGlDsO22.js";import{u as pe}from"./useCabins-lUr51LLB.js";import{I as Qe}from"./Img-DspEm-4v.js";import{D}from"./DropdownMenu-CYwDuq-f.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-DZsNAcem.js";import{R as ne}from"./Row-C4B0ieHd.js";import"./apiCabins-CrcuSlRV.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
