import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-D_d7XbGv.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-B8T-cWBi.js";import{u as Ae}from"./useSettings-hYwb9VJu.js";import{a as qe}from"./apiBookings-B5LHiE7B.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-9CXC5tE2.js";import{C as ae}from"./Checkbox-DvDxh8J3.js";import{F as A,I as me,a as _e}from"./Input-tUxhhbqs.js";import{F as O}from"./FormRow-Dj7k1ktD.js";import{F as Ke}from"./FormRowButtons-DTRsprDg.js";import{T as Ue}from"./Textarea-DzPIZR5k.js";import{u as pe}from"./useCabins-BlIvlB1L.js";import{I as Qe}from"./Img-CkACEI9N.js";import{D}from"./DropdownMenu-7jQTBGyj.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-BnU8ZuEy.js";import{R as ne}from"./Row-CZNi0Cy-.js";import"./apiCabins-B8O_k6Xc.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
