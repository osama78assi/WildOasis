import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-YsPsgoZE.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-BbDCffis.js";import{u as Ae}from"./useSettings-ar-2Q4Vv.js";import{a as qe}from"./apiBookings-P27w9yLR.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-xEQtM6Ts.js";import{C as ae}from"./Checkbox-D3SK_inO.js";import{F as A,I as me,a as _e}from"./Input-BNgRYnlw.js";import{F as O}from"./FormRow-1ZmOA9ZO.js";import{F as Ke}from"./FormRowButtons-gjC0nDO-.js";import{T as Ue}from"./Textarea-dhetgZCw.js";import{u as pe}from"./useCabins-Dc-pELNH.js";import{I as Qe}from"./Img-D67hrg7b.js";import{D}from"./DropdownMenu-DKox6tvh.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-CXSJ7AAj.js";import{R as ne}from"./Row-DxrECGZI.js";import"./apiCabins-DuWsIKyd.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
