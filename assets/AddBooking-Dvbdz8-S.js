import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-C7b2bvWS.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-C4x-XTqp.js";import{u as Ae}from"./useSettings-CE3tSJZw.js";import{a as qe}from"./apiBookings-B5adLHnV.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-Bi0Ndbns.js";import{C as ae}from"./Checkbox-CoFdFO3j.js";import{F as A,I as me,a as _e}from"./Input-D61ntdOD.js";import{F as O}from"./FormRow-DHhgwMt4.js";import{F as Ke}from"./FormRowButtons-qEhoA5HI.js";import{T as Ue}from"./Textarea-DiNGiqY5.js";import{u as pe}from"./useCabins-Dyq4dHmF.js";import{I as Qe}from"./Img-CShqMSru.js";import{D}from"./DropdownMenu-BrpgjsIe.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-D_Ue8X4S.js";import{R as ne}from"./Row-P49_eTiD.js";import"./apiCabins-B-fWmTHZ.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
