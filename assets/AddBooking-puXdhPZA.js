import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-3miXUnVq.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-DuCNFM-e.js";import{u as Ae}from"./useSettings-BjcRq7Xz.js";import{a as qe}from"./apiBookings-DNshKrNf.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-Don_ybCu.js";import{C as ae}from"./Checkbox-CCVJ-Nf-.js";import{F as A,I as me,a as _e}from"./Input-C1EfaEfr.js";import{F as O}from"./FormRow-DV40d1P4.js";import{F as Ke}from"./FormRowButtons-DmUZOSpM.js";import{T as Ue}from"./Textarea-BQ1k7nxo.js";import{u as pe}from"./useCabins-BxQLkgd8.js";import{I as Qe}from"./Img-BsMUe7rC.js";import{D}from"./DropdownMenu-CKDO_fJK.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-DSQyKEb0.js";import{R as ne}from"./Row-C-cmuEam.js";import"./apiCabins-BYM9ffI5.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
