import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-DsZ-KJuj.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-Hn_diU6q.js";import{u as Ae}from"./useSettings-cUTxgVYy.js";import{a as qe}from"./apiBookings-D9ZCHV-r.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-WI_EYfvg.js";import{C as ae}from"./Checkbox-Cq3KPlhs.js";import{F as A,I as me,a as _e}from"./Input-DbooTUb4.js";import{F as O}from"./FormRow-CyTn77u-.js";import{F as Ke}from"./FormRowButtons-BhGb0AGm.js";import{T as Ue}from"./Textarea-Ca-D8YOg.js";import{u as pe}from"./useCabins-BD8uue2S.js";import{I as Qe}from"./Img-CyhXxGng.js";import{D}from"./DropdownMenu-D8-ZbA-5.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-Bc3-1MIG.js";import{R as ne}from"./Row-z4ch16rx.js";import"./apiCabins-DBCjF2WU.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
