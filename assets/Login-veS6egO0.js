import{a as d,j as s,G as p,r as i,q as x,k as v,u as b,$ as y,_ as w,g as C,a0 as j,h as L,a1 as $,a2 as E,i as S}from"./index-DKoFbsHf.js";import{F as M,a as z,I as m}from"./Input-cBXl6r62.js";const F=d.div`
  position: relative;
  display: flex;
...
`,G=d.div`
  ...
  row-gap: 3.2rem;
  margin: auto;
`;function A(){const[e,n]=i.useState("h1");L(500,()=>n("h2"),()=>n("h1"));const t=x(),{isAuthenticated:a}=$();return i.useEffect(()=>{a&&t("/")},[a,t]),s.jsx(D,{children:s.jsxs(G,{children:[s.jsx(E,{h:18}),s.jsx(S,{as:e,$align:"center",children:"Log in to your account"}),s.jsx(q,{})]})})}export{A as default};
