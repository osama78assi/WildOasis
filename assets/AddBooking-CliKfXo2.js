import{t as Te,c as Re,u as oe,_ as U,a as y,G as ce,b as I,r as o,j as e,d as Le,B as Y,H as le,e as de,C as Oe,S as B,f as ue,F as Pe,L as V,g as re,h as ze,i as He}from"./index-Ct-zUf6z.js";import{E as he,u as Ye,R as Ve}from"./ErrorMsg-D3mjF8JR.js";import{u as Ae}from"./useSettings-Ck02eeRc.js";import{a as qe}from"./apiBookings-yQgieiTX.js";import{f as fe,g as L,d as G,i as Ze,a as se}from"./helpers-BKPUiegI.js";import{C as ae}from"./Checkbox-Q1C2DxWw.js";import{F as A,I as me,a as _e}from"./Input-COnufNif.js";import{F as O}from"./FormRow-B_3bwQ61.js";import{F as Ke}from"./FormRowButtons-Bg1M3-9H.js";import{T as Ue}from"./Textarea-BvI2Vy7D.js";import{u as pe}from"./useCabins-DKEOIBDj.js";import{I as Qe}from"./Img-D2oPbqrv.js";import{D}from"./DropdownMenu-Dyyp_UcC.js";import{D as We}from"./constants-BUW7qVOF.js";import{s as Je}from"./apiGuests-C9kj1hLj.js";import{R as ne}from"./Row-CaLoEurf.js";import"./apiCabins-DOTlkt6c.js";function Xe(t){const s=Te(t),n=s.getFullYear(),l=s.getMonth(),i=Re(t,0);return i.setFullYear(n,l+1,0),i.setHours(0,0,0,0),i.getDate()}function et(){const{mutate:t,isPending:s}=oe({mutationFn:qe,onError:n=>{U.error(n.message)}});return{addBooking:t,isLoading:s}}const z=y.div`
  width: 100%;
  display: flex;
